...
struct Atmosphere
{
	...
	static const double mAlbedoAir;
	...
	static double cornettePhase(const double scatteringAngleCos)
	{
		...
		static const double x = 5./9.*u + 125./729.*u*u*u + sqrt(64./27. - 325./243.*u*u + 1250./2187.*u*u*u*u);
		static const double g = 5./9.*u - (4./3. - 25./81.*sqr(u))*pow(x, -1./3.) + pow(x, 1./3.);
